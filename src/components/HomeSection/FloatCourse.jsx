...
export default function FloatCourse({ speed = 20 }) {
  ...
  return (
    <section className="w-full py-10 bg-gradient-to-r from-blue-50 to-white overflow-hidden">
      <div className=" mx-auto">

        <div className="overflow-hidden w-full rounded-sm border border-gray-200 bg-white shadow-sm">
          <div
          ...
          >
            {track.map((course, idx) => (
              ...
              >
                <div
                  className="px-6 py-4 rounded-xl bg-gradient-to-br from-sky-500 to-indigo-500 text-white shadow-md cursor-pointer min-w-[240px] h-full"
                >
                  {/* Title + Trend */}
