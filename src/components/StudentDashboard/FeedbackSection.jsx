...
export default function FeedbackSection({
  ...
  const [internshipRating, setInternshipRating] = useState(0);
  const [generalRemarks, setGeneralRemarks] = useState("");

  const [fieldReviews, setFieldReviews] = useState([
    { fieldName: "", rating: 0, remark: "" },
  ]);
  ...
  async function handleSubmit(e) {
    ...
    if (!resumeFile) {
      setError("Resume is required for submission.");
      return;
    }
  ...
  return (
    <div className="border border-blue-100 bg-white rounded-2xl p-6 shadow-lg relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-5 rounded-xl border">
          <label className="block text-sm font-semibold mb-3">
            Overall Internship Rating
          ...
          <StarRating
            ...
            onRatingChange={setInternshipRating}
          />

          <p className="text-xs text-gray-500 mt-2">
            Rate your overall experience during the internship.
          </p>
        </div>
        ...
        <div className="bg-gray-50 p-4 rounded-xl shadow-sm">
          ...
          <p className="text-xs text-indigo-600 mt-2">
            📌 Note: This resume will be used by our team to share
            with partner companies for placement and job opportunities.
          </p>
        </div>
