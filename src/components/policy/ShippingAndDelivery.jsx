    ...
    <div className="mt-0 lg:mt-2">
      <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-4 lg:p-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl text-gray-900">Digital Delivery Policy</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="grid md:grid-cols-3 gap-6 my-8">
            <div className="text-center p-6 bg-gray-50 rounded-lg border border-green-200">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg border border-purple-200">
          ...
          <div className="space-y-6">
            <section>
              <h2 className="text-xl text-gray-900 mb-4">Digital Delivery Process</h2>
              <div className="flex items-start gap-4 p-2 mb-4">
            ...
            <section>
              <h2 className="text-xl text-gray-900 mb-4">Accessing Your Digital Content</h2>
            ...
            <section>
              <h2 className="text-xl text-gray-900 mb-4">Certificate Delivery</h2>
            ...
            <section>
              <h2 className="text-xl text-gray-900 mb-4">Technical Requirements</h2>
              <div className="p-3">
            ...
            <section>
              <h2 className="text-xl text-gray-900 mb-4">Access Issues & Support</h2>
              ...
              <div className="border-l-4 border-red-300 p-2">
            ...
            <div className="border-l-4 border-blue-300 p-2">
