          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="text-md leading-relaxed max-w-2xl text-gray-200">
              ...
              <div className="space-y-3">
                {contactInfo.map(({ icon: Icon, text, href }, i) => (
                  <a
                    key={i}
                    href={href}
                    className="flex items-center gap-3 text-gray-200 hover:text-orange-400 transition-colors group"
                  >
              ...
              <div className="flex items-center gap-4 pt-3">
                {socialLinks.map(({ icon: Icon, color, label, href }, i) => (
                  <a
                    ...
                    className={`w-8 h-8 bg-gray-800 rounded-xl flex items-center justify-center text-gray-200 ${color} hover:scale-110 transition-all border border-gray-700 hover:border-orange-500/30`}
                    aria-label={label}
                  >
                      ...
                      {items.map(({ name, link }, j) => (
                        <li key={j}>
                          <button
                            ...
                            className="w-full flex items-center gap-2 text-gray-200 hover:text-orange-400 transition group py-1 text-left"
                          >
