...
//   const { subDomain } = useParams(); // 👈 Matches your App.jsx route
...
//       <h1 className="text-3xl font-bold mb-3">{internship.domain}</h1>
//       <img
...
//       <h2 className="text-2xl font-semibold mb-3">Skills You’ll Learn</h2>
...
//         {internship.learningPath?.map((week) => (
//           <div
//             key={week._id}
...
//             </h3>
//             <p className="text-gray-700 mb-2">{week.content}</p>
